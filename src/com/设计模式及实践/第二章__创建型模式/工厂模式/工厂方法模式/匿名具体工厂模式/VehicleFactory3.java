package com.设计模式及实践.第二章__创建型模式.工厂模式.工厂方法模式.匿名具体工厂模式;


class main {
    public static void main(String[] args) {
        VehicleFactory3 carFactory = new CarFactory();
...
// 抽象工厂
public  abstract class VehicleFactory3 {
...
// 实体工厂
class CarFactory extends VehicleFactory3 {
...
//卡车实体工厂
class TruckFactory extends VehicleFactory3 {
